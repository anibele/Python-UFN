...
Original file is located at
    https://colab.research.google.com/drive/1S6IlXAvwz-Q4XC5EWMtsr6g1EWTrnUZ4
"""
...
glicemia = int (input("Insira a glicemia atual em (mg/ml): "))
meta = int (input("Insira sua meta pré-refeição: "))
fator = int (input("Insira seu fator de sensibilidade (Entre 20 e 60): "))
quantidade_insulina = (glicemia - meta) / fator
print("Quantidade de insulina a ser administrada ",quantidade_insulina," unidade(s)")
...
tempo = float(input("Qual o tempo desejado da viagem (em horas)?"))
velocidade = distancia / tempo
print(nome,"A velocidade média necessária é de", velocidade, "km/h")
...
print(nome,"O tempo da viagem é de", tempo, "horas")
...
print("O volume da piscina é : ",total, "cm")
...
cent = metros * 100
print(metros,"em centímetros é", cent, "centímetros")
...
sigla = input("Insira a sigla de seu estado: ").upper()
if sigla == 'RJ':
    print("Carioca")
elif sigla == 'SP':
    print("Paulista")
...
opcao = 'S'
while opcao == 'S':
    opcao = input("Deseja cadastrar uma glicemia? (S/N)").upper()
    if(opcao == 'S'):
      glicemia = int(input('Digite a glicemia'))
...
while opcao == 'S':
    ...
    if(opcao != 'S' and opcao != 'N'):
      print('Opção inválida')
      opcao = 'S'
glicemiasOrdenadas = listaDadosOriginais
glicemiasOrdenadas.sort()
for i in glicemiasOrdenadas:
  print(i)
...
glicemiasOrdenadas = listaDadosOriginais
glicemiasOrdenadas.sort()
print(glicemiasOrdenadas[0])
print(glicemiasOrdenadas[-1])
...
listaDadosOriginais = []
while True:
    opcao = input("Insira a opcao (1 - Cadastrar; 0 - Sair): ")

    if opcao == '1':
        glicemia = int(input("Insira o valor da glicemia "))
        listaDadosOriginais.append(glicemia)
    elif opcao == '0':
        break
...
for i in listaDadosOriginais:
    print(i)

listaDadosOrdenados = listaDadosOriginais
listaDadosOrdenados.sort()

print("\nValores de glicemia ordenados:")
for i in listaDadosOrdenados:
    print(i)

media = sum(listaDadosOrdenados) / len(listaDadosOrdenados)
print("Média das glicemias: ",media)
...
for i in listaDadosOrdenados:
    ...
    if i > media:
        contb+=1
print("Quantidade de número maiores que a media (",media,"): ",conta," quantidade de números menores que a media: ",contb)